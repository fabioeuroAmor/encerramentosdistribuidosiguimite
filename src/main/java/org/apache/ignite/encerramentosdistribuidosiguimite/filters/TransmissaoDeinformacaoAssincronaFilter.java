...
public class TransmissaoDeinformacaoAssincronaFilter implements IgnitePredicate<ClusterNode>{
    ...
    public boolean apply(ClusterNode node) {
        Boolean dataNode = node.attribute("transmissaoDeinformacaoAssincrona.service.node");
