...
public class ExecucaoMetodoAssincronaCallFilter implements IgnitePredicate<ClusterNode>{
    ...
    public boolean apply(ClusterNode node) {
        Boolean dataNode = node.attribute("execucaoMetodoAssincronaCallFilter.service.node");
