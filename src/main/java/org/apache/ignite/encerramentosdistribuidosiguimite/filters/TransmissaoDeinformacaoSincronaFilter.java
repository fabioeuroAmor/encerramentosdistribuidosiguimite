...
public class TransmissaoDeinformacaoSincronaFilter implements IgnitePredicate<ClusterNode>{
    ...
    public boolean apply(ClusterNode node) {
        Boolean dataNode = node.attribute("transmissaoDeinformacaoSincrona.service.node");
